  ...
  materials: {
    ...
    items: [
      ...
      },
      {
        ...
        color: 'purple',
        num: 'Material 06',
        name: 'Direito Constitucional Mapeado',
      ...
      },
      {
        ...
        color: 'green',
        num: 'Material 07',
        name: 'Direito Administrativo Mapeado',
...
function buildPain() {
  ...
  const w = el('div', { class: 'wrap' }, [
    el('div', { class: 'sec-eyebrow r' }, [ ed('pain.eyebrow') ]),
...
function buildFeatures() {
  ...
  const w = el('div', { class: 'wrap' }, [
    el('div', { class: 'sec-eyebrow' }, [ ed('features.eyebrow') ]),
    ...
    (() => {
      ...
      CONTENT.features.items.forEach((f, i) => {
        grid.appendChild(el('div', { class: 'feat f' + (i + 1) }, [
          el('div', { class: 'num' }, [ ed(`features.items.${i}.num`) ]),
  ...
  const w = el('div', { class: 'wrap' }, [
    el('div', { class: 'combo-card' }, [
      ...
      el('div', { class: 'combo-left' }, [
        el('div', { class: 'combo-eyebrow' }, [ ed('combo.eyebrow') ]),
        el('h2', { class: 'combo-h' }, [
          ed('combo.title'),
          el('br'),
...
function buildMaterials() {
  ...
  const w = el('div', { class: 'wrap' }, [
    el('div', { class: 'sec-eyebrow l' }, [ ed('materials.eyebrow') ]),
...
function buildAudiences() {
  const sec = el('section');
  const w = el('div', { class: 'wrap' }, [
    el('div', { class: 'sec-eyebrow p' }, [ ed('audiences.eyebrow') ]),
...
function buildCTAFinal() {
  ...
  const w = el('div', { class: 'wrap' }, [
    el('div', { class: 'sec-eyebrow', style: 'justify-content:center; display:inline-flex;' }, [ ed('ctaFinal.eyebrow') ]),
...
function buildFooter() {
  const f = el('footer');
  const w = el('div', { class: 'wrap' }, [
    el('a', { class: 'ig', href: CONTENT.brand.instagramUrl }, [
      el('span', {}, ['📷']),
      ed('brand.instagram')
    ]),
    el('p', {}, [
      '© ', String(new Date().getFullYear()), ' ',
      ed('brand.name'), ' • Conteúdo gratuito todo dia • Material premium para quem quer ir fundo'
    ])
  ]);
  f.appendChild(w);
  return f;
